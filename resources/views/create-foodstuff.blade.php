    ...
    <div class="container mt-5">
        <form action="{{ route('add-foodstuff') }}" method="post">
            ...
            <div class="form-group mb-3">
                <label for="featured_image">Slika namirnice</label>
                <input type="file" name="featured_image" class="form-control">
            </div>
            <div class="row">
                <div class="col-md-2">
                    <img id="preview-image" src="" alt="slika" style="width: 100px; height: auto; display: none;">
                </div>
            </div>
            <div class="row">
                <hr>
        ...
        submitBtn.addEventListener('click', function(e) {
            ...
            jQuery.ajax({
                ...
                success: function(result) {
                    ...
                    window.location.href = window.origin + '/add-foodstuff-form/';
                },
