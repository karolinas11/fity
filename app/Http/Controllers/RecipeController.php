...
//            }
            ...
            if($holdersMap['pHolder'] == null && $holdersMap['fHolder'] == null && $holdersMap['uHolder'] == null) {
                ...
                $recipeFinal = [
                    ...
                    'uniqueBreakfast' => $recipe->unique_breakfast,
                ];
...
//            }
    ...
    public function generateNewPlan(Request $request) {
        ...
        $user->goal = $request->input('goal') == 'maintain' || $request->input('goal') == 'stable' ? 'stable' : $request->input('goal');
